...
//            products = new ArrayList<>();
            ...
            //Nếu có size
            products = productRepository.searchProductByEntry(req.getBrands(), req.getCategories(), req.getMinPrice(), req.getMaxPrice(), req.getSizes(), LIMIT_PRODUCT_SHOP, pageUtil.calculateOffset());
